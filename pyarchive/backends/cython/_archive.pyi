...
class ArchiveEntry:
    ...
    def get_pointer(self) -> object: ...
    def acl_add_entry(
        self, type_: int, permset: int, tag: int, id_: int, name
    ) -> int: ...
    def acl_add_entry_w(
        self, type_: int, permset: int, tag: int, id_: int, name: str
    ) -> int: ...
...
class ArchiveError(Exception):
    def __init__(
        self, msg, errno: int = ..., retcode: int = ..., archive_p=...
    ) -> ArchiveError: ...
...
class ArchiveRead(Archive):
    ...
    def support_filter_program_signature(
        self, command: bytes, signature: bytes
    ) -> int: ...
