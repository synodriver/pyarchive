...
class Archive:
    ...
    def copy_error(self, other: Archive) -> Any: ...
...
class ArchiveEntry:
    ...
    def set_atime(self, t: int, longns) -> Any: ...
    def set_birthtime(self, t: int, longns) -> Any: ...
    def set_ctime(self, t: int, longns) -> Any: ...
    ...
    def unset_atime(self, t: int, longns) -> Any: ...
    def unset_birthtime(self, t: int, longns) -> Any: ...
    def unset_ctime(self, t: int, longns) -> Any: ...
...
class ArchiveEntryLinkresolver:
    ...
    @classmethod
    def __init__(cls, *args, **kwargs) -> None: ...
    def linkify(self, a: ArchiveEntry, b: ArchiveEntry) -> Any: ...
...
class ArchiveRead(Archive):
    ...
    def open(self, file, block_size: int, boolclose = ...) -> int: ...
